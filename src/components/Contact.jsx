  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn("", "", 0.15, 1)} className={style.subtitle}>
        make the impossible happen, just message me. I'm always eager to explore
        new opportunities and collaborations. Don’t hesitate to reach out—let’s
      ...
      <div className={style.container}>
        <motion.form
          ...
          action="https://formspree.io/f/mqazzkjk"
          method="post"
